...
enum TurbotextInstallLocationService {
    ...
    enum MoveError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .destinationExists:
                return "Am Zielort liegt bereits eine Turbotext-Installation."
            case .destinationNotWritable:
                return "Der Zielordner /Applications ist auf diesem Mac nicht beschreibbar."
            case .copyFailed:
                return "Turbotext konnte nicht nach /Applications kopiert werden."
            }
        }
    }
