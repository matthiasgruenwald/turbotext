...
**Glättung** — Optionale lokale Nachbearbeitung im Live-Diktat, getrennt von der Transkriptionsstufe: Nachdem der Wortlaut feststeht (regulärer Nachlauf oder Datei-Fallback), glättet das geräteinterne Sprachmodell den gesamten Text in einem Durchgang (Satzzeichen, Groß-/Kleinschreibung, offensichtliche Erkennungsfehler), mit Bedeutungserhalt. Der Durchgang hat ein eigenes hartes Zeitbudget; läuft er ab, wird der Rohtext eingefügt — es wird nie auf die Glättung gewartet. Sie läuft nicht während des Einsprechens und blockiert weder die Live-Anzeige noch die Drain-Deadline; als Nachbearbeitung wird sie in der laufbezogenen Verarbeitungsanzeige sichtbar. Im Gegensatz zu „Lokaler Rohtext mit Online-Nachbearbeitung" bleibt der Pfad vollständig gerätelokal. Per Einstellung zuschaltbar; der frühere Name „Live-Glättung" ist historisch, seit die Glättung nicht mehr live im Transkriptionsstrom läuft.
